...
project_name = 'migr_street_to_concept'     
out_csv = sys.argv[2] if len(sys.argv) > 2 else Path(HOME_REPO,'data',project_name, 'source', f'record_uuids_{env}.csv')
                ...
                "queries": [
                    {
                        "queries": [
                            ...
                            },
                            {
                                "type": "FieldQuery",
                                "operator": "empty",
                                "field": "Deed.saa:isAssociatedWithModernAddress.saa:street",
                                "value": ""
                            }
                        ],
                        "type": "AndQuery"
