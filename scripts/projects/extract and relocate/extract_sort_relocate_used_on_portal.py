...
------------------------------------------------------------------------
    ...
    python extract_sort_relocate.py --excel "E:\Maria\test\d_nummers.xlsx" --compressed-source "Q:\Quarantaine\AIP-download\tars\0 tot 1000" --source "Q:\Quarantaine\AIP-download\extracted" --dest   "Q:\Quarantaine\AIP-download\sorted" --dry-run
