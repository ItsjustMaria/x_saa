...
------------------------------------------------------------------------
    ...
    python extract_sort_and_relocate.py --excel "E:\Maria\test\d_nummers.xlsx" --compressed-source "E:\Maria\test\tars" --source "E:\Maria\test\extracted" --dest   "E:\Maria\test\sorted" --dry-run

    # without extraction (old behaviour, --source already has plain folders):
    python organize_archive_files.py --excel "E:\Maria\test\d_nummers.xlsx" --source "E:\Maria\test\extracted" --dest "E:\Maria\test\sorted" --dry-run

    # once you're happy with the dry run:
    python organize_archive_files.py --excel "E:\Maria\test\d-nummers.xlsx" --compressed-source "E:\Maria\test\tars" --source "E:\Maria\test\extracted"    --dest   "E:\Maria\test\sorted"
...
def main():
    ...
    parser.add_argument("--source", required=True, help="Root folder to search for archive folders (extraction target, if --compressed-source is used)")
